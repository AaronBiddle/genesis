<script lang="ts">
    ...
    import ChatInput from '../../ChatboxComponent/ChatInput.svelte';
    import ChatMessages from '../../ChatboxComponent/ChatMessages.svelte';
    import SettingsPanel from '../../ChatboxComponent/SettingsPanel.svelte';
    import { FileOperationsDialog } from '../';
    import { adapters } from '../';
    import { getChatStore } from '../../ChatboxComponent/ChatStore';
    import { registerSession, unregisterSession, reconnectWebSocket } from '../../ChatboxComponent/WebSocketService';
