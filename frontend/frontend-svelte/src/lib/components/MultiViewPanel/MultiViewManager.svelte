...
<div class="flex flex-col h-full">
  <div class="p-4 bg-gray-50 rounded-md mb-4" role="region" aria-labelledby="window-manager-title">
    <h2 id="window-manager-title" class="text-xl font-semibold mb-2">Window Manager</h2>
  ...
  <div class="flex-1 overflow-auto">
    <table class="w-full border-collapse" aria-label="List of open windows">
      <caption class="sr-only">List of all open windows in the workspace</caption>
      <thead>
  ...
  {#if $panels.length === 0}
    <div class="flex flex-col items-center justify-center p-8 text-gray-500" role="status" aria-live="polite">
      ...
      <button 
        ...
        aria-label="Create first window"
      >
        Create First Window
      </button>
    </div>
